<template>
  <section class="page">
    ...
    <p>传入三个位置点，实现二次贝塞尔曲线运动。</p>
    <pre><code class="js" v-text="snippets[1]"></code></pre>
    <i class="placeholder"></i>
    <h3>说明</h3>
    <img src="@/static/textures/bezier.gif" alt="">
    <p>curve.bezier 函数传入一个参数对象，选项如下：</p>
    <ul>
      <li><i>points:</i><i>包含起始点(p0)，控制点(p1)和结束点(p2)的数组</i></li>
    ...
    <p>执行 curve.bezier 函数会返回一个 bezier&lt;object&gt;，包含如下方法：</p>
    <ul>
    ...
    <i class="placeholder"></i>
    <h3>演示</h3>
    <p>curve.bezier 效果演示。</p>
    <iframe width="100%" height="500" src="//jsfiddle.net/JetLu/c67zqh28/66/embedded/result,js/" allowfullscreen="allowfullscreen" allowpaymentrequest frameborder="0"></iframe>
  </section>
</template>
